  ...
  _generateResponses() {
    ...
    switch (this.state) {
      case 'GREETING':
        responses.push({
          text: getRandom([
            "안녕하세요! 저는 마인드 인사이드의 마음챙김 CBT AI 도우미예요. 당신의 마음 이야기를 듣고 싶어요.",
            "반가워요! 마인드 인사이드의 마음챙김 CBT에 오신 것을 환영해요. 오늘 하루 마음은 안녕하신가요?",
            "어서오세요. 느루와 함께 편안하게 이야기 나눌 준비가 되셨나요?",
            "만나서 반가워요. 오늘 하루 어떤 고민이 있었는지 느루에게 들려주세요.",
            "환영합니다! 마인드 인사이드 CBT 공간에서는 어떤 고민이든 편안하게 나눌 수 있어요."
          ]),
          delay: 800
        });
        responses.push({
