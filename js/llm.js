...
· 대시보드 = 우렁이 마음케어 센터(게임): 하단 미니탭으로 방(미니룸 꾸미기)/농장(야채 키우기)/옷장(우렁이 옷)/퀘스트(기분 체크인+오늘 미션, 완료 시 💧물)/훈장(레벨·뱃지·스트릭 보호권)/서재(우편함·주간편지·월간리포트·감정날씨·감정캘린더·지난밤들). 그 아래 사고 기록지와 AI 상담 요약 리포트(주제별 요약 가능)
