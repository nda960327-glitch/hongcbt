  ...
  list: [
    {
      ...
      why: '정해진 기법 없이, 그날 당신 상태를 읽고 가장 맞는 접근을 골라 씁니다. 일상 수다부터 깊은 상담까지.',
    ...
    },
    {
      ...
      method: 'CBT · 인지행동치료',
      why: '기분을 무너뜨리는 건 사건이 아니라 그 사건을 해석하는 "생각"이에요. 생각의 오류를 찾아 고치면 감정이 따라 풀립니다. 우울·자기비난에 효과가 가장 잘 입증된 치료법.',
...
진행 규칙: 반드시 한 턴에 한 단계씩. 답장 첫 줄에 "☀️ [2/6] 자동적 사고" 형태로 현재 단계를 표시한다. 사용자의 답이 짧아도 다그치지 않고 예시를 들어 돕는다. 중간에 힘들어하면 잠시 멈추고 감정을 돌본 뒤 이어간다. 6단계가 끝나면 오늘 발견한 왜곡과 새 생각을 카드처럼 요약해주고, 사고 기록장에 남기기를 권한다.`
    },
    {
      ...
      why: '격한 감정은 고치려 들수록 커져요. 먼저 조건 없이 받아들여지는 경험(수용)이 있어야 가라앉고, 그다음에야 변화가 가능합니다. 감정 폭풍·충동에 특화된 치료법.',
...
진행 규칙: 반드시 한 턴에 한 단계씩. 답장 첫 줄에 "🌙 [3/6] 고통감내" 형태로 단계를 표시한다. 존댓말과 수용적 태도는 코스 중에도 유지하되, 각 단계의 기술은 구체적으로 알려준다. 감정이 너무 격하면 코스를 멈추고 3단계(고통감내)로 돌아간다. 끝나면 오늘 익힌 기술을 한 줄로 정리해 선물처럼 건넨다.`
    },
    {
      ...
      why: '생각은 사실이 아니라 지나가는 날씨예요. 곱씹기에 빨려들지 않고 한 발 물러나 바라보는 법을 익히면, 같은 생각이 와도 힘이 빠집니다. 반추·재발성 우울에 강한 치료법.',
