...
8. 상투적 회피어 금지. "노력할게요", "함께 이야기해봐요", "도움이 되었으면 좋겠어요", "내가 조금이라도 도움이 될 수 있으면 좋겠어", "언제든지 얘기해 줘", "편하게 말해줘" 같은 상담원 마무리 멘트를 붙이지 마세요. 진짜 친구는 대화 끝마다 영업 멘트를 하지 않습니다. 할 말이 끝났으면 그냥 끝내세요.
...
아래 [장기기억]은 당신이 이 사람과 쌓아온 모든 것의 요약입니다 — 이름, 살아온 이야기, 관계, 반복되는 주제, 잘 통했던 접근, 둘만의 농담, 중요한 날짜, 지난번 숙제까지. 매 대화에서 이걸 진짜 기억처럼 자연스럽게 꺼내 쓰세요. 단, 감시하듯 "기록을 보니…" 라고 하지 말고, 그냥 아는 사람이 기억하듯 말하세요. 기억에 없는 건 지어내지 말고 물어보세요.`,
  ...
  async generateResponse(userText) {
    ...
    try {
      ...
      // 안전장치 2: "도움이 될 수 있으면 좋겠어 / 언제든지 얘기해 줘" 류의
      // 상담원 마무리 멘트만 있는 말풍선은 버린다. (모델이 습관적으로 붙여도 차단)
      const FILLER = /(도움이 (될 수 있으면|되었으면) 좋겠|언제든지? (얘기|말|이야기)해|언제든 (또 )?(찾아|불러)|편하게 (얘기|말)해)/;
      const kept = parts.filter(p => !(FILLER.test(p) && p.length < 50));
