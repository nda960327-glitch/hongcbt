...
window.I18N = {
  ...
  map: {
    en: {
      ...
      '추천 제휴 콘텐츠': 'In-person Care', '대면상담 및 진료': 'In-person Care', '마음 건강을 위한 맞춤형 정보': 'Curated picks for your mind',
      '마인드 인사이드 앱 설치하기': 'Install the Mind Inside app', '홈 화면에 추가하고 더 빠르고 편하게 이용하세요!': 'Add to your home screen for quick access!',
      '앱 다운로드': 'Install app', '마인드 인사이드 앱 다운로드': 'Get the Mind Inside App', '무료 앱 설치하기': 'Install free app', '다음에 할게요': 'Maybe later',
      // 챗봇
      '마음속 이야기를 적어주세요': "Share what's on your mind...",
      ...
      '생각의 그늘을 밝혀주는 CBT 선생님': 'CBT teacher who shines light on dark thoughts',
      ...
      '사고 기록지': 'Thought Log', '느루가 대화에서 정리해둔 마음 기록 보러가기': "See the records Neuru kept from your chats",
...
'리뷰 남기기':'Write review','다시 예약':'Book again',
      '느루의 기억': "Neuru's Memory", '걱정 마세요, 느루는 당신을 잊지 않아요.': "Don't worry — Neuru never forgets you.",
      '대화를 지워도, 앱을 껐다 켜도, 리포트가 오래되어 정리돼도 — 당신과 나눈 이야기는 전부 느루의 기억 속에 그대로 있어요.': 'Even if chats are cleared, the app restarts, or old reports get tidied away — everything you shared stays safe in Neuru\'s memory.',
...
'전체 앱 데이터 초기화':'Reset all app data','앱 모든 데이터 초기화하기':'Erase everything',
      // 비밀·감정 흐름
'느루와의 비밀':"Just between you and Neuru",
      '여기서 나눈 이야기는 오직 이 휴대폰 안에만 저장돼요. 어떤 서버에도 쌓이지 않고, 그 누구에게도 공유되지 않아요. 답변을 만드는 순간에만 안전하게 처리될 뿐, 흔적은 남지 않습니다. 당신과 느루, 둘만의 비밀이에요.': 'Everything you share stays only on this phone. Nothing piles up on any server, and no one else ever sees it. It is processed securely only for the moment a reply is made — no trace left. A secret between you and Neuru.',
      '오늘 나눈 감정 이야기가 아직 적어요. 지금 기분을 이야기해보면 흐름이 그려져요.': "Not much feeling-talk today yet. Share how you feel and the flow will appear.",
'아래에서 위로, 마음이 올라온 하루예요':'Your mood climbed up today',
'마음이 조금 가라앉았네요. 느루가 곁에 있을게요':"Your mood dipped a bit. Neuru is right here",
'오늘은 대체로 편안하게 흘러갔어요':'A mostly calm, easy day',
'오늘은 마음이 묵직한 편이었어요. 잘 버텨냈어요':'A heavy-hearted day — you held on well',
      // 기타
...
'오늘의 느루 미션':"Today's Neuru Mission",'몸이 움직이면 마음이 따라와요':'Move the body, the mind follows',
'했어요!':'Done!','다른 거':'Another','오늘 미션 완료!':'Mission complete!',
      '움직임': 'Move', '즐거움': 'Joy', '연결': 'Connect', '돌봄': 'Care', '마음': 'Mind', '느루 맞춤': 'Picked for you',
'오늘 하루, 정리하고 잘까요?':'Wrap up today before bed?',
      '자기 전 딱 3분, 느루가 오늘을 같이 돌아봐드려요': 'Just 3 minutes — Neuru reviews the day with you',
      '하루 정리': 'Daily Wrap-up', '3분 회고': '3-min review', '마음 안정': 'Calm Down', '호흡·그라운딩': 'Breathing & grounding',
      // 대시보드 신규 카드
'감정 캘린더':'Mood Calendar','날짜를 누르면 그날의 일기가 열려요':'Tap a day to open its diary',
'나의 마음 정원':'My Mind Garden','나를 돌본 만큼 자라나요':'It grows as you care for yourself',
'느루의 주간 편지':"Neuru's Weekly Letter",
      '일주일의 감정·기록을 모아 느루가 편지로 정리해드려요. (일요일 밤 추천)': 'Neuru gathers your week into a letter. (Best on Sunday night)',
'이번 주 편지 받기':'Get this week\'s letter','이번 주 편지 다시 쓰기':'Rewrite this week\'s letter',
'지난 밤들':'Past Nights','자기 전 느루와 함께 정리한 하루들이에요.':'Days you wrapped up with Neuru before bed.',
      '오늘 정리하기': 'Wrap up today',
      // 마이페이지 신규
'나의 꾸준함':'My Consistency','느루 캐시':'Neuru Cash','마인드 인사이드 구독':'Subscription',
      '충전 금액이 클수록 보너스 캐시가 커져요': 'Bigger top-ups earn bigger bonus cash',
      // 학습·퀴즈
      '느루 선생님의 마음 수업': "Teacher Neuru's Mind Class",
'느루 탐정의 생각 함정 찾기':"Detective Neuru's Trap Hunt",'수사 시작하기':'Start investigating',
...
'느루에게 힌트 받기':'Get a hint from Neuru','다음 ›':'Next ›','‹ 이전':'‹ Back','건너뛰기':'Skip'
    },

    ja: {
      '홈': 'ホーム', '챗봇': 'AI相談', 'AI심리상담': 'AI相談', '상담사 매칭': 'カウンセラー', '전화 심리상담': '電話カウンセリング', '대시보드': 'ダッシュボード', '마이': 'マイ',
      '마인드 인사이드 홈': 'マインドインサイド ホーム',
      ...
      '추천 제휴 콘텐츠': '対面相談・診療', '대면상담 및 진료': '対面相談・診療', '마음 건강을 위한 맞춤형 정보': '心の健康のための情報',
      '마인드 인사이드 앱 설치하기': 'アプリをインストール', '홈 화면에 추가하고 더 빠르고 편하게 이용하세요!': 'ホーム画面に追加して快適に！',
      '앱 다운로드': 'インストール', '마인드 인사이드 앱 다운로드': 'マインドインサイドアプリ', '무료 앱 설치하기': '無料でインストール', '다음에 할게요': 'また今度',
      '마음속 이야기를 적어주세요': '心の中の話を気軽に書いてください…',
      ...
      '생각의 그늘을 밝혀주는 CBT 선생님': '思考のかげに光を当てるCBTの先生',
      ...
      '사고 기록지': '思考記録ノート', '느루가 대화에서 정리해둔 마음 기록 보러가기': 'ヌルがまとめた記録を見る',
...
'리뷰 남기기':'レビューを書く','다시 예약':'再予約',
      '느루의 기억': 'ヌルの記憶', '걱정 마세요, 느루는 당신을 잊지 않아요.': '大丈夫、ヌルはあなたを忘れません。',
      '대화를 지워도, 앱을 껐다 켜도, 리포트가 오래되어 정리돼도 — 당신과 나눈 이야기는 전부 느루의 기억 속에 그대로 있어요.': '会話を消しても、アプリを閉じても、古いレポートが整理されても — あなたと話したことは全部ヌルの記憶に残っています。',
...
'전체 앱 데이터 초기화':'全データ初期化','앱 모든 데이터 초기화하기':'すべて消去する',
'느루와의 비밀':'ヌルとの秘密',
      '여기서 나눈 이야기는 오직 이 휴대폰 안에만 저장돼요. 어떤 서버에도 쌓이지 않고, 그 누구에게도 공유되지 않아요. 답변을 만드는 순간에만 안전하게 처리될 뿐, 흔적은 남지 않습니다. 당신과 느루, 둘만의 비밀이에요.': 'ここで話したことはこのスマホの中だけに保存されます。サーバーには残らず、誰にも共有されません。返事を作る瞬間だけ安全に処理され、痕跡は残りません。あなたとヌル、二人だけの秘密です。',
      '오늘 나눈 감정 이야기가 아직 적어요. 지금 기분을 이야기해보면 흐름이 그려져요.': '今日はまだ気持ちの話が少ないです。今の気分を話すと流れが描かれます。',
'아래에서 위로, 마음이 올라온 하루예요':'下から上へ、気分が上がった一日です',
'마음이 조금 가라앉았네요. 느루가 곁에 있을게요':'少し沈んだ日でしたね。ヌルがそばにいます',
'오늘은 대체로 편안하게 흘러갔어요':'今日はおおむね穏やかな一日でした',
'오늘은 마음이 묵직한 편이었어요. 잘 버텨냈어요':'重たい心の日でした。よく耐えました',
      '이해했습니다, 시작하기': '理解しました、始める', '도움이 필요하신가요?': '助けが必要ですか？', '대화 계속하기': '会話を続ける',
      // 홈: 체크인·미션·야간·도구
      '지금 마음은 어때요?': '今の気分はどう？',
      '기쁨': 'うれしい', '편안': 'おだやか', '보통': 'ふつう', '불안': '不安', '우울': 'ゆううつ',
'오늘의 느루 미션':'今日のヌルミッション','몸이 움직이면 마음이 따라와요':'体が動けば心もついてくる',
'했어요!':'できた！','다른 거':'別のを','오늘 미션 완료!':'ミッション達成！',
      '움직임': '運動', '즐거움': '楽しみ', '연결': 'つながり', '돌봄': 'ケア', '마음': 'こころ', '느루 맞춤': 'あなた専用',
'오늘 하루, 정리하고 잘까요?':'今日を振り返って寝ましょうか？',
      '자기 전 딱 3분, 느루가 오늘을 같이 돌아봐드려요': '寝る前の3分、ヌルが一日を一緒に振り返ります',
      '하루 정리': '一日のまとめ', '3분 회고': '3分の振り返り', '마음 안정': '心の応急処置', '호흡·그라운딩': '呼吸・グラウンディング',
      // 대시보드 신규 카드
'감정 캘린더':'気分カレンダー','날짜를 누르면 그날의 일기가 열려요':'日付をタップするとその日の日記が開きます',
'나의 마음 정원':'心の庭','나를 돌본 만큼 자라나요':'自分をケアした分だけ育ちます',
'느루의 주간 편지':'ヌルの週間レター',
      '일주일의 감정·기록을 모아 느루가 편지로 정리해드려요. (일요일 밤 추천)': '一週間の気持ちと記録をヌルが手紙にまとめます。（日曜の夜がおすすめ）',
'이번 주 편지 받기':'今週の手紙をもらう','이번 주 편지 다시 쓰기':'今週の手紙を書き直す',
'지난 밤들':'これまでの夜','자기 전 느루와 함께 정리한 하루들이에요.':'寝る前にヌルとまとめた日々です。',
      '오늘 정리하기': '今日をまとめる',
      // 마이페이지 신규
'나의 꾸준함':'わたしの継続','느루 캐시':'ヌルキャッシュ','마인드 인사이드 구독':'サブスク',
'충전 금액이 클수록 보너스 캐시가 커져요':'チャージが大きいほどボーナスも大きい',
      // 학습·퀴즈
      '느루 선생님의 마음 수업': 'ヌルの心の授業',
'느루 탐정의 생각 함정 찾기':'ヌル探偵の思考のわな探し','수사 시작하기':'捜査開始',
...
'느루에게 힌트 받기':'ヌルにヒントをもらう','다음 ›':'次へ ›','‹ 이전':'‹ 戻る','건너뛰기':'スキップ'
    }
  }
};
