window.Storage = {
  ...
  // === Free Mode Session Limit (무료: 30회 제한) ===
  FREE_SESSION_LIMIT: 30,

  getFreeSessionCount() {
    return this._safeGet('cbt_free_sessions', this.FREE_SESSION_LIMIT);
  },
  ...
  // === Pro Mode Session Limit (유료: 무제한 — 카운트 미사용, 하위호환용 유지) ===
  getProSessionCount() {
