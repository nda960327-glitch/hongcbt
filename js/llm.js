...
· AI 마음 리포트(구 AI 진단서, 대시보드, 30,000캐시): 표준 선별검사 PHQ-9(우울)·GAD-7(불안)을 원문항 그대로 실시해 표준 절단점으로 채점하고, 나머지 축은 '탐색 지표(비표준)'로 구분해 분석하는 참고용 리포트. 진단이 아님을 꼭 안내. 검진에서 자해 문항 응답 시 1393 안내
...
· 방·농장 상단에 '💧 물이 고이는 돌봄' 퀵버튼(체크인/퀘스트/하루정리/사고기록/호흡)이 있어 바로 이동 가능
