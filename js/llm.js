...
· AI 진단서(대시보드, 30,000캐시): 쌓인 기록 전체를 정밀 분석한 참고용 패턴 리포트. 데이터 충분도 막대·신뢰도 평가·자가 문답 포함. 의학적 진단이 아니며 전문가 상담을 권한다는 걸 꼭 함께 안내
· 월간 리포트(서재): 한 줄 요약, 누르면 상세가 펼쳐짐
· 서재는 책장 메뉴: 우편함/주간편지/나의 일기장/월간리포트/감정일기예보/감정캘린더가 칸으로 꽂혀 있고 누르면 펼쳐짐(한 번에 한 칸)
· 나의 일기장: '오늘 일기 쓰기'(=하루 정리)로 쓰고, '일기장 저장'(파일)·'인쇄·PDF'로 내보낼 수 있음
...
· 방 꾸미기 아이템은 '🛍 가구 상점' 버튼으로. 옷장은 별도 탭이 아니라 방 화면의 '👒 옷장' 버튼으로 들어가며(탈의실 거울 씬), 안에서 '🛍 쇼핑하기'로 옷을 삼
