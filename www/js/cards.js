// ============================================================================
//  오늘의 느루 카드 — 하루 한 장, 마음에 쥐여주는 문장
//  피드처럼 무한히 넘기게 하지 않는다. 딱 한 장이라서 읽고, 하루 종일 남는다.
//  문장은 CBT·ACT·자기자비의 언어를 느루 말투로 옮긴 자체 덱 30장.
...
window.Cards = {
  DECK: [
    ...
    '오늘 웃을 일이 없었다면, 느루가 한 번 웃겨드릴게요 — 채팅에 놀러 와요.',
    ...
    el.innerHTML = `
      <div style="display: flex; align-items: flex-start; gap: 0.6rem;">
        ...
        <div style="flex: 1; min-width: 0;">
          <p style="margin: 0 0 0.15rem; font-size: 0.68rem; font-weight: 800; color: var(--text-muted);">오늘의 느루 카드</p>
