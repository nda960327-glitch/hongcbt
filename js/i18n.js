...
window.I18N = {
  ...
  map: {
    en: {
      ...
      '느루 앱 설치하기': 'Install the Neuru app', '홈 화면에 추가하고 더 빠르고 편하게 이용하세요!': 'Add to your home screen for quick access!',
      '앱 다운로드': 'Install app', '느루 앱 다운로드': 'Get the Neuru App', '무료 앱 설치하기': 'Install free app', '다음에 할게요': 'Maybe later',
      // 챗봇
...
'지난 밤들':'Past Nights','자기 전 느루와 함께 정리한 하루들이에요.':'Days you wrapped up with Neuru before bed.',
      ...
      // 마이페이지 신규
'나의 꾸준함':'My Consistency','느루 캐시':'Neuru Cash','느루 구독':'Subscription',
...
'느루에게 힌트 받기':'Get a hint from Neuru','다음 ›':'Next ›','‹ 이전':'‹ Back','건너뛰기':'Skip'
    ...
    ja: {
      ...
      '느루 앱 설치하기': 'アプリをインストール', '홈 화면에 추가하고 더 빠르고 편하게 이용하세요!': 'ホーム画面に追加して快適に！',
      '앱 다운로드': 'インストール', '느루 앱 다운로드': 'ヌルアプリ', '무료 앱 설치하기': '無料でインストール', '다음에 할게요': 'また今度',
...
'지난 밤들':'これまでの夜','자기 전 느루와 함께 정리한 하루들이에요.':'寝る前にヌルとまとめた日々です。',
      '오늘 정리하기': '今日をまとめる',
      // 마이페이지 신규
'나의 꾸준함':'わたしの継続','느루 캐시':'ヌルキャッシュ','느루 구독':'サブスク',
